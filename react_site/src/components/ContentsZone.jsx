...
import img01 from "../img/album_01 (1).jpg"
export function ContentsZone(){
    const _img02 = "../img/album_02.jpg";
    const items = [
        {img:require("../img/album_01 (1).jpg"), date:"2015-01-01", view_count:121, content:"1.비가 오나 눈이 오나 걱정없는 실내 바비큐장에서 사계절 편안하게 드세요~본 내용은 샘플로 작성되었으며 추후에 관리자가 펜션에 맞게 직접 내용을 등록하실 수 있습니다. 감사합니다."},
                      ...
                      <table class="album" border="0" style={{width:'100%'}}>
                        {
                          ...
                          <tr key={index}>
                              ...
                              <td>
                                  <a href="#">
                                     {item.content}                                    
                                      <div align="right">[<font style={{color:'#878787',fontSize:12}}>작성일자 : {item.date}</font>, <font style={{color:'#878787',fontSize:12}}>조회수 : {item.view_count}</font>]</div>                         
                                  </a>
                              </td>
                          </tr>
                            ))
